window.onload = function() {
  ...
  //     alignment: 'center', // Displays dropdown with edge aligned to the center of button
  //   });
 // 	//expand the story
	...
	// document.getElementById("submit").onclick = alertMessages();

	// function alertMessages() {
    	
 //    		Response.Write("<script language='javascript'>window.alert('Your Message');window.location='http://localhost:3000/login';</script>");
    	
 //    		Response.Write("<script language='javascript'>window.alert('Your Message');window.location='http://localhost:3000/stories';</script>");
